# Con-Nav-Item - 现代化个人导航站 v1.0.5

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](LICENSE)
[![Version](https://img.shields.io/badge/Version-1.0.5-brightgreen.svg)](https://github.com/zczy-k/Con-Nav-Item/releases)
...
1) 新建目录并写入 `docker-compose.yml`（也可以直接使用仓库里的 `docker-compose.yml`）
